...
export const Usuarios = () => {
    ...
    const [usuarios, setUsuarios] = useState([]); // Definicion del estado usuarios
    const [editUserId, setEditUserId] = useState(null);
    const [newName, setNewName] = useState("");

    // Funcion para obtener los usuarios desde Supabase
        ...
        // Funcion para actualizar un usuario (cambiar nombre o rol)
